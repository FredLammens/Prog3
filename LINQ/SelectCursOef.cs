...
namespace LINQ
{
    class SelectCursOef
    {
        public static void Select1(IList<Program.Student> studentList) 
        {
        ...
        public static void Select2(IList<Program.Student> studentList) 
        {
        ...
        public static void Select3(IList<Program.Student> studentList) 
        {
        ...
        public static void Select4(IList<Program.Student> studentList) 
        {
        ...
        public static void Select5(IList<Program.Student> studentList) 
        {
